...
<form action="process/add-data.php?id=peminjaman" method="post">	
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
      	<select name="idmember" id="inputNama" class="form-control" style="margin-bottom: 10px;">
      		<option value=""></option>
      		<?php
	...
	<div class="form-group">
      ...
      <div class="col-lg-10">
        <input type="number" min=1 max=300 name="spd" class="form-control" id="inputSpd" placeholder="Jml Sepeda" style="width:100%; margin-bottom: 10px;">
      </div>
    </div>

	<div class="form-group padd">
      <div class="col-lg-10 col-lg-offset-2">
		<button class="btn btn-primary" name="btn" style="float: right;"><span class="fa fa-save"></span> Simpan</button>
	  </div>
	</div>
