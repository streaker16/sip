...
<form action="process/add-data.php?id=pengembalian" method="post" id="form_kembali">
	...
	<div class="row">
		...
		<div class="col-sm-2">
			<label for="jam_pinjam">Waktu Peminjaman</label>
		</div>
		<div class="col-sm-10">
			<div class="row">
				<div class="col-sm-2">
					...
					<span class="jam_pinjam">00</span>:<span class="jam_pinjam2">00</span>
	...
	<div class="row">
		<div class="col-sm-2">
			<label for="jam_kembali" id="pengembalian">Waktu Pengembalian</label>
		</div>
		<div class="col-sm-10">
			<div class="row">
				<div class="col-sm-2">
					...
					<span class="jam_kembali">00</span>:<span class="jam_kembali2">00</span>
	...
	<div class="form-group padd">
      <div class="col-lg-10 col-lg-offset-2">
		<button class="btn btn-primary" name="btn" style="float: right; margin-right: -15px;"><span class="fa fa-save"></span> Proses</button>
	  </div>
	</div>
